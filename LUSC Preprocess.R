...
#Clinical data
#Either Download clinical data from here(http://gdac.broadinstitute.org/runs/stddata__2016_01_28/data/LUSC/20160128/gdac.broadinstitute.org_LUSC.Merge_Clinical.Level_1.2016012800.0.0.tar.gz)
#use LUSC-TP.merged_data.txt data file.
# Or follow steps below to retrieve it by R
clinical <- survivalTCGA(LUSC.clinical,
...
#Methylation data
#Download methylation data from here (http://gdac.broadinstitute.org/runs/stddata__2016_01_28/data/LUSC/20160128/gdac.broadinstitute.org_LUSC.Methylation_Preprocess.Level_3.2016012800.0.0.tar.gz)
#Use the LUSC-TP.meth.by_min_clin_corr.data.txt
methylation <- read.table("D:/BHI/Spring 2024/BHI 699/Thesis Documents/Data/lung/LUSC/Methylation/luscmeth.txt", sep = "\t")
...
#Drop the normal tissue samples.
samples_normal <- grepl("\\-11$", methylation2$caseid)

methylation2 <- methylation2[!samples_normal, ]

# Remove .01 from case id to match it with clinical case id
...
#Save data frame
write.csv(methylation2, "D:/BHI/Spring 2024/BHI 699/Thesis Documents/Data/lung/LUSC/Methylation/smlaf.csv", row.names = TRUE)
...
#Download Gene Expression data from here (http://gdac.broadinstitute.org/runs/stddata__2016_01_28/data/LUSC/20160128/gdac.broadinstitute.org_LUSC.mRNAseq_Preprocess.Level_3.2016012800.0.0.tar.gz)
#Use the LUSC-TP.uncv2.mRNAseq_RSEM_normalized_log2.txt file
gene2 <- read.table("D:/BHI/Spring 2024/BHI 699/Thesis Documents/Data/lung/LUSC/gene expression/luscgene.txt", sep = "\t")
...
#Replace Missing values with KNN
#gene2 <- knnImputation(gene2)

#remove columns of genes which has 0 or na values
gene3 <- gene3[, colSums(is.na(gene3)) ==0]

#impute missing data using MICE function
#gene2 <- complete(mice(as.data.frame(gene2)))
...
#Save data frame
write.csv(gene3, "D:/BHI/Spring 2024/BHI 699/Thesis Documents/Data/lung/LUSC/gene expression/sglaf.csv", row.names = TRUE)
